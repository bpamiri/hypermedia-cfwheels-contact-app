  ...
  |----------------------------------------------------------------------------------------------|
    ...
    EXAMPLE:
      ...
      t.time(columnNames='lunchStarts', default='', null=true);
			...
			t.create();
*/
component extends="wheels.migrator.Migration" hint="creates contacts table" {

	function up() {
		transaction {
			try {
				t = createTable(name = 'contacts');
				t.string(columnNames="first", default="", null=true, limit="50");
				t.string(columnNames="last", default="", null=true, limit="50");
				t.string(columnNames="phone", default="", null=true, limit="20");
				t.string(columnNames="email", default="", null=true, limit="50");
				t.timestamps();
				t.create();
			} catch (any e) {
				local.exception = e;
